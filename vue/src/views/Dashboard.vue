<template>
    <PageComponent title="Dashboard">
        <div v-if="loading" class="flex items-center justify-center space-x-2 animate-pulse">
        ...
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
            ...
            >
                <h3 class="text-2xl font-semibold">Lastest Survey</h3>
                <img 
...
store.dispatch("getDashboardMeta")
