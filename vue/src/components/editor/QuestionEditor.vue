...
<div>
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-9">
            <label 
                ...
                class="bloc text-sm font-medium text-gray-700"
            >Question Text</label>
            <input type="text"
    ...
    <!-- Data -->
    <div>
        <div v-if="shouldHavedOptions()" class="mt-2">
...
<script setup>
    ...
    function typeChange(){
        if(shouldHavedOptions()){
            setOptions(getOptions() || [])
        }
        dataChange()
    }

    //Emmit the data change
    function dataChange(){
